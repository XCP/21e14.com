    ...
    >
      ...
      <div className="mt-6 flex">
        <input
          ...
          required
          className="min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white px-3 py-[calc(theme(spacing.2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-xcpBlue focus:outline-none focus:ring-4 focus:ring-xcpBlue/10 sm:text-sm dark:border-zinc-700 dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-xcpBlue dark:focus:ring-xcpBlue/10"
        />
        ...
        {[image1, image2, image3, image4, image5].map((image, imageIndex) => (
          ...
          >
            <Image
              src={image}
              alt=""
              sizes="(min-width: 640px) 36rem, 18rem"
              quality={100}
              className={clsx(
                'absolute inset-0 h-full w-full object-cover',
                imageIndex === 2 && 'object-left' // Apply object-left to the third image
              )}
            />
          </div>
        ))}
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Open-source data and tools for Counterparty <span className="hidden md:inline">(XCP)</span>
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            Counterparty economy <span className="hidden md:inline"> on Bitcoin</span>. Whether it be a blockchain
            explorer, NFT project, or dex trading tool, I build things
            that help showcase the onchain activity and market value of
            Counterparty assets. ❤️
          </p>
