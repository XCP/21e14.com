...
export const metadata = {
  ...
  openGraph: {
    ...
    description: article.description,
    type: 'article',
    url: 'https://www.21e14.com/articles/xcp-supply-crunch',
    images: [
      {
        url: 'https://www.21e14.com/images/research.png',
        width: 1200,
        height: 630,
        alt: 'The Coming XCP Supply Crunch EXPOSED',
      },
    ],
  },
  twitter: {
    ...
    title: article.title,
    description: article.description,
    images: ['https://www.21e14.com/images/research.png'],
  },
}
