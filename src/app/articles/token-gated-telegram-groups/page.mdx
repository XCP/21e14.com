...
The classic Counterparty solution has been John Villar's [telly-kickbot](https://github.com/chiguireitor/telly-kickbot), created back in 2017 to gate the HAIRPEPE Salon for holders of the legendary HAIRPEPE token. A Venezuelan contributor to Counterparty who sadly passed away, Villar built something that worked well for its time. RIP.
