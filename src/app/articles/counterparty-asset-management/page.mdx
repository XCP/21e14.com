...
There is niche investor interest in asset names. The first asset registered (besides the native XCP) was TEST. It sat dormant for years, and when it finally became available for sale, the price ran up [as high as $30k](https://tokenscan.io/tx/243075d4b62719a0e97ec8cd26bba61cd72cd585c0bd83743ca85f656e94d316)—not for its art but for its name and position in history.
...
Registering a "named" asset like MYTOKEN costs 0.5 XCP while registering a "numeric" asset like [A7337447728884561000](https://stampchain.io/stamp/17686488353b65b128d19031240478ba50f1387d0ea7e5f188ea7fda78ea06f4) just costs the BTC tx fee.
...
One prolific portfolio is owned by J-Dog, who created [XChain](https://tokenscan.io/) (the most popular and long-standing explorer) and [CoinDaddy](https://coindaddy.io/), with this same asset-name-as-domain-name vision.
...
SECURE THE NAMES! ([MY BAGS](https://xcpfolio.com/))