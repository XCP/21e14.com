...
- **Mechanism:**  
  Any NFT submission that reaches its soft cap becomes accepted into the collection, effectively allowing the community to curate the collection organically. You could identify them by an asset name prefix or a certain description or a mined address prefix.
