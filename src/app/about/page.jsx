      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="prose dark:prose-invert mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            ...
            <p>And I owe the Counterparty community a lot. After all, I live in a home that their memes paid for. (That&apos;s saying something in this economy.)</p>
            <h2>Counterparty</h2>
